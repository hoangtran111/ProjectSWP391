            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="createbook.jsp"  class="btn btn-success">Add New Book</a>						
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        <c:forEach items="${listb}" var="o">
                            <tr>
                                ...
                                <td>${o.authorID}</td>
                                <td>
                                    <a <a href="editbook?bid=${o.bookID}"  class="btn btn-success">edit</a>
                                    <a href="delete?sid=${o.bookID}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
